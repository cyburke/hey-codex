...
final class SettingsWindowController: NSWindowController {
    ...
    private func buildView() {
        ...
        let sensitivityHint = label("More sensitive catches a quieter voice, but raises the chance of an accidental wake. Hey Codex listens for one phrase and nothing else.")
        ...
        let shortcutHint = label("This must match ChatGPT’s Voice chat hotkey exactly — Hey Codex simply presses it for you. Change it in both places or neither.")
